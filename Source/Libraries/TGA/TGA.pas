...
uses Classes, SysUtils, Graphics{, GLCrossPlatform};
...
begin
   ...
   case header.PixelSize of
      24 : PixelFormat:= pf24bit {glpf24bit};
      32 : PixelFormat:= pf32bit {glpf32bit};
   else
...
begin
   ...
   case PixelFormat of
   {$IFDEF MSWINDOWS}
      {gl}pf24bit : header.PixelSize:=24;
   {$ENDIF}
      {gl}pf32bit : header.PixelSize:=32;
   else
